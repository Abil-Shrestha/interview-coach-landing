          ...
          <div className="">
                    ...
                    {linePosition === "left" || linePosition === "right" ? (
                      ...
                      >
                        <div
                          ...
                          } origin-top bg-gradient-to-b from-primary to-primary/80 transition-all ease-out dark:from-white dark:to-white/80`}
                          style={{
                            transitionDuration:
                              currentIndex === index
                                ? `${collapseDelay}ms`
                    ...
                    {linePosition === "top" || linePosition === "bottom" ? (
                      ...
                      >
                        <div
                          ...
                          } origin-left bg-gradient-to-r from-primary to-primary/80 transition-all ease-out dark:from-white dark:to-white/80`}
                          style={{
                            transitionDuration:
                              currentIndex === index
                                ? `${collapseDelay}ms`
            ...
            >
              {data[currentIndex]?.component ? (
                <motion.div
                  key={currentIndex}
                  className="aspect-auto h-full w-full flex items-center justify-center min-h-[600px] p-8"
